...
export function useAuditActions({
    ...
    }, [handleActionStart, handleActionEnd, toast, setFixedMismatches]);
    ...
    }, [handleActionStart, handleActionEnd, reportData, toast, setFixedMismatches, setSelectedHandles]);
    ...
    }, [handleActionStart, handleActionEnd, reportData, fileName, onRefresh, setCreatedProductHandles, toast]);
    ...
    }, [handleActionStart, handleActionEnd, reportData, fileName, setCreatedProductHandles, setSelectedHandles, toast]);
    ...
    // These update state, so wrap them.
    ...
    return {
        ...
        startAutoCreate,
        stopAutoCreate,
        setIsAutoRunning, // exposed for effect, setter is stable
        setIsAutoCreating // exposed for effect, setter is stable
    };
}
