...
// Define locally to avoid import issues and minimize refactoring scope
interface LogEntry {
  id: string;
  timestamp: string;
...
// Extracted and memoized row component to prevent unnecessary re-renders
const LogEntryRow = memo(({ log }: { log: LogEntry }) => {
  return (
