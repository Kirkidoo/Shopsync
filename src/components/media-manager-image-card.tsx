          ...
          <Tooltip>
            <TooltipTrigger asChild>
              <button
                ...
                className={cn(
                  'pointer-events-auto absolute bottom-1.5 right-1.5 inline-flex h-6 w-6 items-center justify-center rounded-full bg-secondary/80 text-secondary-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring',
                  isMissingVariantMode && 'hidden'
                )}
              >
