            ...
            <AlertDialog>
              ...
              <AlertDialogContent>
                <AlertDialogHeader>
                  ...
                  <AlertDialogDescription>
                    This product has {imageCount} images but only {items.length} variants (SKUs).
                    This action will permanently delete the {imageCount! - items.length} unlinked
                    images from Shopify. This cannot be undone.
                  </AlertDialogDescription>
                </AlertDialogHeader>
                <AlertDialogFooter>
          ...
          {productId && !isMissingVariantCase && (
            ...
            >
              ...
              {imageCount !== undefined && (
                <span className={cn(imageCount > items.length ? 'font-bold text-yellow-400' : '')}>
                  ({imageCount})
                </span>
              )}
            </Button>
                    ...
                    <AlertDialogContent>
                      <AlertDialogHeader>
                        ...
                        <AlertDialogDescription>
                          ...
                          permanently delete the entire product and its {items.length} variants from
