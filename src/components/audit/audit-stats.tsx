      ...
      <div className="flex items-start justify-between">
        <div>
          ...
          <div className="mt-2 flex items-center text-sm text-muted-foreground">
            ...
            <code className="ml-2 rounded-md bg-primary/10 px-2 py-1 text-primary">{fileName}</code>
          </div>
        </div>
      ...
      {duplicates.length > 0 && filter !== 'duplicate_in_shopify' && (
        <Alert variant="destructive" className="mt-4">
          ...
          <AlertDescription>
            ...
            products. This can cause issues with inventory and order fulfillment. View them in the
            &apos;Duplicate in Shopify&apos; tab.
          </AlertDescription>
        </Alert>
      )}
